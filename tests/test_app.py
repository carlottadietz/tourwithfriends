...
class TourWithFriendsTests(unittest.TestCase):
    ...
    def test_ceremony_dashboard_shows_podium_overtakes_and_stage_wins(self):
        ...
        self.assertIn(b"Verlauf pro Fahrer", response.data)
        self.assertIn(b"Alle Fahrerlinien liegen uebereinander", response.data)
        ...
        self.assertIn(b"Aenderungen anzeigen", response.data)
        self.assertIn(b"Neue Aenderungen im Siegerehrungs-Dashboard", response.data)
